class Courir extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.spritesheet('gerardrun', 'assets/run.png', { frameWidth: 33, frameHeight: 32 });
    }
...
//CREATION DES ANIMATIONS DU PERSONNAGE GRACE AU SPRITESHEET
        ...
        this.anims.create({
            key: 'runleft',
            frames: this.anims.generateFrameNumbers('gerardrun', { start: 0, end: 5 }),//CE SONT LES IMAGES 0/1/2/3 QUI SONT JOUEES
            frameRate: 10,//NOMBRE D'IMAGES JOUEES
            repeat: -1//REPETITION INFINIE
        });
        this.anims.create({
            key: 'runright',
            frames: this.anims.generateFrameNumbers('gerardrun', { start: 6, end: 11 }),//CE SONT LES IMAGES 0/1/2/3 QUI SONT JOUEES
            frameRate: 10,//NOMBRE D'IMAGES JOUEES
            repeat: -1//REPETITION INFINIE
        });
