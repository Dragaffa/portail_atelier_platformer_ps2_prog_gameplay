class Planner extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.spritesheet('planner', 'assets/plane.png', { frameWidth: 27, frameHeight: 53 });
    }
...
//CREATION DES ANIMATIONS DU PERSONNAGE GRACE AU SPRITESHEET
        ...
        this.anims.create({
            key: 'plane',
            frames: [ { key: 'planner', frame: 0 } ],//C'EST L'IMAGE 4 QUI EST JOUEE
            frameRate: 20//NOMBRE D'IMAGES JOUEES
        });
