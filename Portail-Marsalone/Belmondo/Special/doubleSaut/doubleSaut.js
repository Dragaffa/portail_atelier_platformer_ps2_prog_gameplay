class DoubleSaut extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.spritesheet('jump1', 'assets/saut1.png', { frameWidth: 29, frameHeight: 32 });
        this.load.spritesheet('jump2', 'assets/saut2.png', { frameWidth: 29, frameHeight: 32 });
    }
...
//CREATION DES ACTIONS DU PERSONNAGE
        player = this.physics.add.sprite(100, 450, 'gerard');
...
//CREATION DES ANIMATIONS DU PERSONNAGE GRACE AU SPRITESHEET
        ...
        this.anims.create({
            key: 'jump1',
            frames:  [ { key: 'jump1', frame: 0 } ],//CE SONT LES IMAGES 5/6/7/8 QUI SONT JOUEES
            frameRate: 10,//NOMBRE D'IMAGES JOUEES
            repeat: 1//REPETITION INFINIE
        });
        ...
        this.anims.create({
            key: 'jump2',
            frames:  [ { key: 'jump2', frame: 0 } ],//CE SONT LES IMAGES 5/6/7/8 QUI SONT JOUEES
            frameRate: 10,//NOMBRE D'IMAGES JOUEES
            repeat: 1//REPETITION INFINIE
        });
